...
class TestStrategiesCommand extends Command {
    ...
    use Config, Signals, Strategies, OHLC;

    protected $name = 'my:test_strategies';

    protected $signature = 'my:test_strategies {--demo}';
    ...
    {
        if ($rundemo = $this->option('demo')) {
            $this->info('Running the DEMO test of all strategies:');
        }
        ...
        $instruments     = $this->bowhead_config('PAIRS');
